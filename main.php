...
//auto loading files
if ( !function_exists('mf_autoload') ) {
...
//function by hand
if ( !function_exists('mf_update_db_check') ) {
...
if( is_admin() ) {
  ...
  if ( !function_exists('mf_enqueue_scripts') ) {
  ...
  if ( !function_exists('hide_panels') ) {
  ...
  if ( !function_exists('mf_add_meta_boxes') ) {
   ...
   */
  if ( !function_exists('mf_dispatcher') ) {
